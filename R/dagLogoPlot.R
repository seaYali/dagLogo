...
#' dagLogoPlot(t0)
#' dagLogoPlot(t1, groupingSymbol = getGroupingSymbol(t1@group))
#' dagLogoPlot(t2, groupingSymbol = getGroupingSymbol(t2@group))
#' dagLogoPlot(t3, groupingSymbol = getGroupingSymbol(t3@group))
#' dagLogoPlot(t4, groupingSymbol = getGroupingSymbol(t4@group))


dagLogoPlot <- function(testDAUresults,
                    type = c("diff", "zscore"),
                    pvalueCutoff = 0.05,
