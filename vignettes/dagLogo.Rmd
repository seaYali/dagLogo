...
And another package motifStack[@Jianhong2012] was developed for drawing sequence logos for amino Acid, DNA and RNA sequences, which also has the capability for graphical representation of multiple motifs.
...
```{r prepareProteome0}
proteome <- prepareProteome(source = "UniProt", taxonID = "9606")
```
